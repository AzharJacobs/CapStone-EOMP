<template>
  ...
  <footer class="footer-section">
    <div class="container relative">
      <div class="sofa-img">
        <!-- <img src="@/assets/images/sofa.png" alt="Sofa Image" class="img-fluid" /> -->
      </div>
        ...
        <div class="col-lg-8">
          <div class="subscription-form">
            <h3 class="d-flex align-items-center">
              <span class="me-1">
                <!-- <img src="@/assets/images/envelope-outline.svg" alt="Envelope Image" class="img-fluid" /> -->
              </span>
              <span>Subscribe to Newsletter</span>
            </h3>

            <form @submit.prevent="subscribe" class="row g-3">
              <div class="col-auto">
