<template>
        ...
        <div class="row justify-content-between">
          ...
          <div class="col-lg-7">
            <div class="hero-img-wrap">
              <img src="https://azharjacobs.github.io/AzharImages/Capstone/couch.png" class="img-fluid" alt="Couch">
            </div>
          </div>
        </div>
      </div>
    ...
    <!-- Start Contact Form -->
    <div class="untree_co-section" style="background-color: #f7f7f7;">
      <div class="container">
        <div class="block">
            ...
            <div class="col-md-8 col-lg-8 pb-4">
              ...
              <form @submit.prevent="submitForm">
                ...
                <div class="form-group mb-5">
                  ...
                  <textarea v-model="message" class="form-control" id="message" cols="30" rows="5"></textarea>
                </div>
